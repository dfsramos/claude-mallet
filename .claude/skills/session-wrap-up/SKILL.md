...
description: Structured end-of-session review. Use when the user agrees to a session wrap-up, or says "wrap up", "all done", or "end session". Produces a retrospective, applies skill and directive improvements, processes the skill backlog, and saves a session record.
---
# Session Wrap-Up
